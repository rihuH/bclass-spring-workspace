...
<!-- Alertify 검색해서 getStarted에서 JDN복사해서 가져옴 CSS -->
...
<body>
	...
	<c:if test="${not empty alertMsg}">
		...
		//get the closable setting value.
		 ...
		 // 쓰고 싶은 거 찾아서 밑에 복사붙여넣기
		 alertify.dialog('alert').set({transitionOff:true,message: 'Transition Off: true'}).show(); 
		 alertify.alert()
		   .setting({
		     'label':'Agree',
		     'message': '${alertMsg}' ,
    ...
    <div id="header">
        <div id="header_1">
            ...
            <div id="header_1_right">
                ...
                <a href="/hyper/enrollForm.me">회원가입</a><!-- member를 앞에 붙이고 @RequestMapping(value="member")해두면 더 정확한 표현이 될 수 있다 -->
        ...
        <div id="header_2">
            <ul>
                ...
                <!-- 상대경로방식인 a href="boards"로 적으면, 상대경로방식의 경우 맨 마지막 슬래시/ 뒤에 바로 붙으므로,
                지금 디테일 조회를 위해 boards/15/이런식으로 된 후 다시 메뉴바를 누르면 그 뒤에 boards가 되는 문제점. 
                따라서 /hyper/ 를 추가하여 다시 바꾸어줌. -->
