...
<body>
	...
	<h1 id="title"><label style="color:#2586b4;">${title }</label>의 정보!</h1>
	...
	<div id="map" style="width:100%;height:550px"></div> <!-- 지도를 표시할 div 입니다 -->
...
content += '    <a href="https://place.map.kakao.com/17600274" target="_blank"><strong>${title}</strong></a>';
